--[[
   CREDITS TO WHOEVER MADE SPECTOR GUI - AS I FOUND THIS IN A PUBLIC GUI LIBRARY REPO
]]--
            ...
            function pagetypes:Section(options)
                ...
                function sectiontypes:Keybind(options)
                    ...
                    if keybindtype and keybindtype:lower() == "toggle" then
                        ...
                        services.InputService.InputBegan:Connect(function(input, typing)
                    ...
                    if keybindtype and keybindtype:lower() == "hold" then
                        ...
                        services.InputService.InputEnded:Connect(function(input, typing)
                            if typing then return end
                            if input.UserInputType == Enum.UserInputType.Keyboard then
                                if input.KeyCode == keychosen then
                                    if holdflag then
